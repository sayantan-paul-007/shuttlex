...
const Hero = () => {
  return (
    <section className='px-4 w-full mobile:px-5 tablet:px-6 laptop:px-8 desktop:px-12 desktop-large:px-16 desktop-xl:px-24 desktop-4k:px-32  text-white h-[90vh] desktop-large:h-[80vh] desktop-2k:h-[70vh] bg-hero-img bg-cover bg-center '>
      
      <div className='container flex flex-col  h-[70%] justify-between gap-y-10'>
        <div>
      ...
      <p className='font-body text-md tablet:text-lg desktop-large:text-xl desktop-2k:text-3xl desktop-4k:text-5xl'>The ultimate guide of SpaceX missions</p>
